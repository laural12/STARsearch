...
class Orientation:
    ...
    def __init__(self):
      ...
      self.DEBOUNCE_VAL = 3 # Arbitrary; how many triggers to wait before trusting the limit switch
      ...
      # Function setup
      wpi.wiringPiISR(self.rot.LIMIT_ENC_AZ, wpi.INT_EDGE_RISING, self.azLimitswitchHit)
